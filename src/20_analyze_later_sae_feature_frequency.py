...
OUTPUT_PATH = PROJECT_ROOT / "outputs" / "sae_layers_6_9_12_top100_feature_frequency.csv"
...
def main() -> None:
    ...
    print(f"Saved later-layer SAE feature frequency analysis to: {OUTPUT_PATH}")
    print()
