...
OUTPUT_PATH = PROJECT_ROOT / "outputs" / "sae_feature_frequency_by_type.csv"
...
def main() -> None:
    ...
    if not rows:
        print("No types had both correct and wrong samples.")
        return
    ...
    print(f"Saved type-controlled SAE feature analysis to: {OUTPUT_PATH}")
    print()
