...
OUTPUT_DIR = PROJECT_ROOT / "outputs" / "activations_later"

MODEL_NAME = "google/gemma-2-2b"
LAYERS_TO_SAVE = [6, 9, 12]


def main() -> None:
    OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

    for old_file in OUTPUT_DIR.glob("*.pt"):
        old_file.unlink()
    ...
    print(f"Saved later-layer activation metadata to: {metadata_path}")
